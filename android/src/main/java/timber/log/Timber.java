...
public final class Timber {
    ...
    private static final Tree TREE_OF_SOULS = new Tree() {
        ...
        @Override protected void log(int priority, String tag, @NotNull String message, Throwable t) {
            throw new AssertionError("Missing override for timber.log method.");
        }
    };
    ...
    public static abstract class Tree {
        ...
        /**
         * Formats a timber.log message with optional arguments.
         */
        ...
        /**
         * Write a timber.log message to its destination. Called for all level-specific methods by default.
         *
         * @param priority Log level. See {@link Log} for constants.
         * @param tag Explicit or inferred tag. May be {@code null}.
         * @param message Formatted timber.log message. May be {@code null}, but then {@code t} will not be.
